<template>
  <div :class="classes">
    <div :class="[datePrefix+ '-list']" ref="hours">
      <ul :class="[datePrefix + '-ul']">
        <Scroll always disabledX>
          <li
    ...
    <div :class="[datePrefix+ '-list']" ref="minutes">
      <ul :class="[datePrefix + '-ul']">
        <Scroll always disabledX>
          <li
            :class="getCellCls(item)"
    ...
    <div :class="[datePrefix+ '-list']" v-show="showSeconds" ref="seconds">
      <ul :class="[datePrefix + '-ul']">
        <Scroll always disabledX>
          <li
            :class="getCellCls(item)"
...
import { deepCopy, firstUpperCase } from "../../../utils/assist";
import { prefix } from "../../var";
const datePrefix = prefix + "time-cells";
  ...
  computed: {
    classes() {
      return [
        `${datePrefix}`,
        {
          [`${datePrefix}-with-seconds`]: this.showSeconds
        }
      ];
    },
    hoursList() {
