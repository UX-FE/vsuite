                ...
                <div :class="classes" :style="mainStyles" v-show="visible">
                    <div :class="contentClasses" ref="content">
                        ...
                        <div :class="[prefixCls + '-body']" :style="styles">
                            <Scroll always autoX><slot></slot></Scroll>
                        </div>
                        <div :class="[prefixCls + '-footer']" v-if="hasFooter" :style="styles"><slot name="footer"></slot></div>
                    </div>
                    <div class="vsu-drawer-drag" :class="{ 'vsu-drawer-drag-left': placement === 'left' }" v-if="draggable" @mousedown="handleTriggerMousedown">
                        <slot name="trigger">
                            <div class="vsu-drawer-drag-move-trigger">
                                <div class="vsu-drawer-drag-move-trigger-point">
                                    <i></i><i></i><i></i><i></i><i></i>
                                </div>
                            </div>
                        </slot>
            ...
            contentClasses () {
                return [
                    `${prefixCls}-content`,
                    {
                        ...
                        [`${prefixCls}-content-has-footer`]: this.hasFooter
                    }
                ];
            },
            classes () {
